...
export type LegalSheetType =
  "Terms of Service" | "Privacy Policy" | "Help & Support" | "What's New";
      ...
      content = (
        <div className="p-5 text-white/80 space-y-4 pb-20">
          ...
          <p className="text-[15px] leading-relaxed">
            Welcome to Acomo. These terms govern your use of our application. By
            using Acomo, you agree to these terms.
          </p>

          <h3 className="text-white font-bold text-lg mt-6">2. User Data</h3>
          <p className="text-[15px] leading-relaxed">
            Your financial data is stored locally on your device by default. We
            do not have access to your transactions unless you explicitly opt-in
            to cloud backup features.
          </p>

          <h3 className="text-white font-bold text-lg mt-6">
            3. Prohibited Activities
          </h3>
          <p className="text-[15px] leading-relaxed">
            You agree not to modify, reverse engineer, or attempt to extract the
    ...
    case "Privacy Policy":
      content = (
        <div className="p-5 text-white/80 space-y-4 pb-20">
          ...
          <p className="text-[15px] leading-relaxed">
            Acomo is designed with privacy in mind. We collect minimal analytics
            data to improve the application experience, and this data is
            entirely anonymized.
          </p>

          <h3 className="text-white font-bold text-lg mt-6">Data Usage</h3>
          <p className="text-[15px] leading-relaxed">
            Your data is used exclusively to provide and improve the Acomo app.
            We do not sell your personal information to third parties.
          </p>

          <h3 className="text-white font-bold text-lg mt-6">Data Security</h3>
          <p className="text-[15px] leading-relaxed">
            We use industry-standard security measures to protect your data. If
            you use cloud sync features, your data is encrypted during transit
            and at rest.
          </p>
        </div>
      );
              ...
              <ul className="text-[15px] text-white/80 space-y-3">
                <li className="flex items-start gap-2.5">
                  <Circle
                    weight="fill"
                    size={6}
                    className="text-emerald-500 mt-2 shrink-0"
                  />
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white/5 rounded-xl p-4 border border-white/10">
              ...
              <p className="text-[14px] text-white/60">
                You can export your data from the Profile page under Data
                Management. It will be saved as a CSV file.
              </p>
            </div>
            ...
            <div className="bg-white/5 rounded-xl p-4 border border-white/10">
              ...
              <p className="text-[14px] text-white/60">
                Currently, data is stored locally on your device. Cloud sync is
