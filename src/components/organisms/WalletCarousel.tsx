...
export const WalletCarousel = () => {
  ...
  return (
    <div className="w-full">
      ...
      <div className="flex overflow-x-auto gap-4 pb-1 no-scrollbar -mx-4 px-4 snap-x snap-mandatory">
        {wallets.map((wallet) => (
          <div
            key={wallet.id}
          ...
          >
            <p className="text-white/80 text-[13px] font-medium mb-1 truncate">
              {wallet.name}
            </p>
        ...
        >
          ...
          <span className="text-[13px] text-white/50 font-medium group-hover:text-white transition-colors">
            Add Wallet
          </span>
        </div>
      </div>
      ...
      <IosSheet
        ...
        title={sheetMode === "add" ? "New Wallet" : "Edit Wallet"}
      >
