...
export const LoginForm = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-[#1C1C1E]/70 to-[#2C2C2E]/70 backdrop-blur-2xl p-8 sm:p-10 rounded-[20px] shadow-2xl border border-white/10 text-foreground">
