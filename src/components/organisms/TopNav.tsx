...
export const TopNav = () => {
  ...
  return (
    <header className="absolute top-0 left-0 right-0 h-[72px] flex items-center justify-between px-5 z-40 bg-gradient-to-b from-black/80 to-transparent pointer-events-auto">
