...
export const DashboardStats = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-[#1C1C1E]/70 to-[#2C2C2E]/70 backdrop-blur-2xl p-5 rounded-[20px] border border-white/10 shadow-2xl relative overflow-hidden">
      <h3 className="text-white/60 text-sm font-medium mb-2 relative z-10">
        Total Balance
      </h3>
